...
<template>
    <div class="min-h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
        <nav class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="flex h-16 justify-between">
                    <div class="flex items-center">
                        <Link :href="route('dashboard')" class="inline-flex items-center">
                            <img
                                src="/chickenlogo.png"
                                alt="Chicken Marketplace"
                                class="h-12 w-12 rounded-md object-contain"
                            />
                        </Link>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <NavLink v-if="user" :href="route('dashboard')" :active="route().current('dashboard')">Dashboard</NavLink>
                            <NavLink :href="route('listings.index')" :active="route().current('listings.index')">Marketplace</NavLink>
                            <NavLink v-if="user" :href="route('messages.index')" :active="route().current('messages.index')" class="relative">
                                Messages
                            ...
                            <NavLink v-if="user?.role === 'seller'" :href="route('seller.orders.index')" :active="route().current('seller.orders.index')" class="relative">
                                Incoming Orders
                            ...
                            <NavLink v-if="user?.role === 'buyer'" :href="route('buyer.orders.index')" :active="route().current('buyer.orders.index')" class="relative">
                                My Purchases
                    ...
                    <div class="flex items-center gap-2 sm:hidden">
                        ...
                        <button
                            ...
                            class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:outline-none dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"
                        >
            ...
            <div v-show="showingNavigationDropdown" class="sm:hidden">
                <div class="space-y-1 pb-3 pt-2">
                    ...
                    <Link v-if="user" :href="route('messages.index')" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Messages</Link>
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 py-6 lg:px-8"><slot /></main>
    </div>
</template>
